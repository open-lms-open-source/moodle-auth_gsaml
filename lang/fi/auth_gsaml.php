...
$string['gsamlsetuptableinfo'] = '<ol><li>Määritä <b>Toimialuenimi</b>-Google-palvelun toimialuenimen kohtaan ja napsauta <b>Tallenna muutokset</b>.<br/><br/></li>
...
<li>Napsauta<b>Lisätyökalut</b>-välilehteä.<br/><br/></li>
<li>Napsauta sitten <b>Set up single sign-on (SSO)</b> (Määritä kertakirjautuminen) -linkkiä kohdassa Authentication (Todennus).<br/><br/></li>  <li>Merkitse ensin <b>Enable Single Sign-on</b> (Ota kertakirjautuminen käyttöön) -valintaruutu.<br/><br/></li>
<li>Lisää tämä URL-osoite <b>Sign-in page URL</b> (Kirjautumissivun osoite) -tekstikenttään.<br/><b>{$a->wwwroot}/login/index.php</b><br/><br/></li>  <li>Lisää tämä URL-osoite <b>Sign-out page URL</b> (Uloskirjautumissivun osoite) -tekstikenttään.<br/><b>{$a->wwwroot}/login/logout.php</b><br/><br/></li>
<li>Lisää tämä URL-osoite <b>Change password URL</b> (Salasanan vaihdon osoite) -tekstikenttään.<br/><b>{$a->wwwroot}/login/change_password.php</b><br/><br/></li>
<li>Luo ja lataa <b>tarkistusvarmenne Googleen (julkisen avaimen sisältämä X.509-varmenne).</b><br/><br/></li>
<li>Lataa yksityinen avain ja varmenne myös Moodleen ja napsauta sitten <b>Tallenna muutokset</b></b>.<br/></li></ol>';
...
<p>Google-palvelun täydellinen integrointi Moodleen edellyttää muutamien määritystoimien tekemistä. Tämä ohjetiedosto opastaa
Google-todennuslisäosan määrittämisessä sekä GData-lohkon  ja Gmail-lohkon valmistelemisessa.</p>
...
<li>Ota SSO-toiminto käyttöön Google-sivustossa napsauttamalla merkki valintaruutuun.</li>
<li>Ota API-valmistelu käyttöön Google-sivustossa, tai muuten käyttäjiä ei päivitetä.</li>
<li>Varmista, että API-valmistelu on otettu käyttöön Google-sivustossa.</li>
<li>Saatat joutua pyytämään lisää käyttäjätilejä Googlen puolella.</li>
<li>Palaa Moodlen pääsivulle.</li>
<li>Napsauta Muokkaa.</li>
<li>Lisää GAccess-, GMail- ja Gdata-lohkot sivulle.</li>
<li>Napsauta <b>Google Apps</b> -lohkossa <b>Asetukset</b>. Lisää määritystiedot.</li>
...
<li>Tarkista salasanakäytäntö.</li>
<li>Määritä salasanan pituudeksi vähintään 6 merkkiä (Googlen salasanakäytännön vaatimus).</li>
<li>Lisää synkronoitavat käyttäjät GData-lohkoon. Voit tehdä tämän napsauttamalla Lisää synkronoitavat käyttäjät -linkkiä <b>Google Apps -lohkossa</b>.
Voit tarkistaa tulokset asettamalla          GData-lohkon Cron-päivitysväliksi 1 min.</li>
...
<ul class="alternate" type="square">
<li>GMail-syötettä ei välttämättä löydy. Tämä johtuu luultavasti siitä, että käyttäjän salasana ei täsmää käyttäjän Google-salasanaan.
...
Tämä toiminta voi vaikuttaa MNet-käyttäjiin. Tähän ongelmaan ei vielä ole ratkaisua.</li>
...
<p>Diagnostiikkasivulla on tietoa Gmail-, GData- ja SAML-yhteyden tilasta.
...
<div class="indent">
GData-lohko, joka sijaitsee blocks-kansiossa, sisältää eri Google-palvelujen kirjastot. Varmista, että lohko pystyy muodostamaan yhteyden Google-palveluihin. Tarvittaessa voit muuttaa arvoja GData-lohkon Asetukset-sivulla.
</div>

<h3><a name="gmail" href="#gmail">Gmail-lohkon yhteystesti</a></h3>
<div class="indent">
Tällä hetkellä Gmail-lohko päivittää käyttäjän lukemattomat viestit ainoastaan kirjautumisen yhteydessä. Tämän testin voi suorittaa vain, kun virheenkorjaustila on käytössä. Lukemattomien viestien reaaliaikaisen tarkastelun tuki on kehityksessä.

</div>

<h3><a name="saml" href="#saml">SAML SSO -tilan testaus</a></h3>
<div class="indent">
SAML-tilan testaus on SSO-valtuutusprosessista erillään toimiva tarkistus. Sitä ei ole vielä otettu käyttöön.
<!--Virhetiedot saa näkyviin ottamalla kirjautumisen yhteydessä käyttöön DEBUG_DEVELOPER-virheenkorjaustilan. -->
</div>';
$string['keys'] = 'Avaimet';
$string['keys_help'] = '<span style="font-size: 1.2em">
<h3>Googlen SSO-avaimet</h3>
<p>Sekä Moodlen että Googlen on voitava valtuuttaa tärkeiden resurssien suojattu käyttö.
...
<li>Valitse <b>Add my url</b> (Lisää URL-osoite).</li>
<li>Anna moodlegadget-pienoisohjelman URL-osoite.</li>
<li>URL-osoite on tämänkaltainen: <br/><b>http://www.omamoodletoimialue.org/auth/gsaml/moodlegadget.php </b>
...
<li>Napsauta <b>Takaisin kotisivulle</b>.</li>
