...
puede guiarlo a lo largo de la mayor parte del proceso para configurar el complemento de autenticación de Google, como también para dejar listos el block de GData y el block de Gmail.</p>
...
<li>Habilite el complemento <b>Autenticación de Google</b> en la página Administrar complementos</li>
...
<li>Para cargar esos usuarios de Moodle a Google, puede ejecutar el cron manualmente desde admin/cron.php. Los resultados de la sincronización deberían aparecer en la zona de lectura.
...
<!--Pero con la depuración activada y puesta en DEBUG_DEVELOPER, la información de error debe revelarse al iniciar sesión.-->
</div>';
$string['keys'] = 'Claves';
...
El administrador debe generar un <b>Certificado de verificación</b> y cargar un certificado con formato X.509 con una clave pública incrustada.
