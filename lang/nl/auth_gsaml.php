...
$string['gsamlsetuptableinfo'] = '<ol><li>Stel de <b>Domeinnaam</b> in op de naam van je Google-servicedomein en klik op <b>Bewaar wijzigingen</b><br/><br/></li>
...
<li>Klik op de koppeling <b>Stel eenmalige aanmelding (SSO) ins</b> naast Verificatie.<br/><br/></li>
...
<li>Upload de persoonlijke sleutel en het certificaat ook naar Moodle en klik vervolgens op <b>Bewaar wijzigingen</b></b><br/></li></ol>';
...
<p>Voor het instellen van de volledige integratie van Google naar Moodle is een configuratie nodig. Dit Help-bestand begeleidt je door het grootste deel van het proces om de Google-invoegtoepassing voor verificatie te configureren en ervoor te zorgen dat het GData-blok en Gmail-blok gereed zijn.</p>
...
<ol>
    ...
    <li>Schakel de <b>Google-verificatie</b>invoegtoepassing in vanaf de beheerpagina Beheer invoegtoepassingen</li>
    <li>Selecteer Gebruikersverificatie en ga naar <b>Google-verificatie</b> voor aanwijzingen op de pagina die opgevolgd moeten worden.</li>
    ...
    <li>Ga naar Sitebeheer &gt; Beveiliging &gt; Sitebeheer</li>
    ...
    <li>In het GData-blok moet je gebruikers toevoegen voor de sync. Doe dit door op de koppeling Voeg gebruikers toe voor sync te klikken in het <b>Google Apps-blok</b>. Het resultaat is beter zichtbaar als je de cron van het GData-blok instelt op 1 min.</li>
...
<ul class="alternate" type="square">
    ...
    <li>De locatie van de Google-invoegtoepassing voor verificatie in de verificatievolgorde is belangrijk.
    ...
    Dit gedrag kan van invloed zijn op MNet-gebruikers. Er is nog geen oplossing voor
    dit probleem gevonden.</li>
...
<ol>
    ...
    <li>Klik op de koppeling <b>Voeg items toe</b></li>
    <li>Klik op <b>Voeg mijn URL toe</b></li>
    ...
    <li>Nadat je de URL in het veld URL hebt gekopieerd, klik je op <b>Voeg toe</b></li>
