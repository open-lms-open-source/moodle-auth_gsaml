...
<li>Innanzitutto, selezionare la casella <b>Abilita Single Sign-on</b>.<br/><br/></li>
<li>Quindi inserire questo URL nel campo di testo <b>URL pagina di accesso</b>.<br/><b>{$a->wwwroot}/login/index.php</b><br/><br/></li>
...
$string['sixcharmsg'] = 'La password utente deve essere più lunga di 6 caratteri per l\'integrazione di Google. Contattare l\'amministratore per regolare le impostazioni dei criteri del sito';
...
$string['notadminnoperm'] = 'Non sei un amministratore del sito. Non disponi dell\'autorizzazione per visualizzare queste informazioni.';
...
$string['gsamlsuccess'] = 'Operazione eseguita con successo';
...
$string['contextinstanceid'] = 'ID istanza';
$string['courseid'] = 'ID corso';
$string['eventname'] = 'Nome evento';
$string['otherlog'] = 'Altro';
$string['useraccesedgservice'] = 'L\'utente ha effettuato prima l\'accesso a gservice';
$string['userneedsredirect'] = 'L\'utente ha una richiesta saml ma ha bisogno di un login/reindirizzamento';
$string['userislogged'] = 'L\'utente ha effettuato il login e ha una richiesta saml';
$string['login'] = 'Login';
...
illustra la maggior parte dei processi utili per configurare il plugin di autenticazione di Google, il block GData
e il block disponibile per Gmail.</p>
...
<li>blocks/mgadget (facoltativo in quanto beta)</li>
</ul>
</ol>
</p>
...
<li>Abilita il plugin <b>Autenticazione di Google</b> dalla pagina di amministrazione Gestisci plugin</li>
...
<li>Aggiungi i blocchi GAccess, Gmail e GData alla pagina.</li>
...
<li>Accedi ad Amministrazione del sito &gt; Sicurezza &gt; Criteri del sito</li>
<li>Verifica il criterio relativo alla password</li>
<li>Imposta la lunghezza della password su 6 o superiore (richiesto dalle regole sulla password di Google)</li>
<li>Nel block GData devi gli aggiungere utenti da sincronizzare. Fai clic sul link Aggiungi utenti da sincronizzare nel <b>block
Google Apps</b>. Per visualizzare i risultati è utile impostare il          cron del block GData su 1 min.</li>
...
<li>Facendo clic su qualsiasi link di Google Service o accedendo ai servizi dalla pagina dei partner Google
si viene autenticati su Moodle.</li>
<li>Gli utenti devono essere connessi a Moodle e ai servizi dei partner di Google</li>
<li>Consulta la <b>pagina Diagnostica</b> nelle impostazioni GSAML per maggiori informazioni sulla configurazione.</li>
</ul>


<h4><a name="pre" href="#consider">Considerazioni (versione BETA)</a></h4>
<ul class="alternate" type="square">
...
$string['diagnostics_help'] = '<h2>Diagnostica integrazione di Google</h2>
<p>La pagina Diagnostica mostra informazioni riguardanti lo stato della connessione di Gmail, GData e SAML.
Solo gli amministratori hanno l\'autorizzazione per visualizzare le informazioni della diagnostica.</p>
...
<li><a href="#saml">Test dello stato SSO SAML</a></li>
</ul>
...
<h3><a name="gdata" href="#gdata">Connessione di GData</a></h3>
<div class="indent">
Il block GData situato nella cartella block contiene le librerie di diversi servizi Google. Devi confermare
che sia in grado di collegarsi ai servizi di Google. Se necessario modifica i valori nella pagina delle impostazioni del block GData.
</div>

<h3><a name="gmail" href="#gmail">Test di connessione block Gmail</a></h3>
<div class="indent">
Al momento il block Gmail aggiorna soltanto i messaggi non letti degli utenti dopo il login. Sarai in grado
di eseguire il test qui solo se il debugging è attivato. Il supporto per la visualizzazione dei messaggi non letti in tempo reale è in arrivo.
</div>

<h3><a name="saml" href="#saml">Test dello stato SSO SAML</a></h3>
<div class="indent">
...
<li>Fai clic sul link <b>Aggiungi elementi</b></li>
<li>Fare clic su <b>Aggiungi il mio url</b></li>
...
<h3><a name="status" href="#status">Considerazioni (versione BETA)</a></h3>
<div class="indent">
Questa versione è un prototipo beta del Gadget Google Moodle. In futuro potrebbe essere maggiormente utile.
Al momento è presente un bug noto del Gadget che impedisce l\'aggiornamento immediato dopo l\'installazione.
