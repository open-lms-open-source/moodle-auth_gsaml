...
<li>Öffnen Sie Seite der Google Apps-Systemsteuerung in einem neuen Fenster als Administrator (<a href="https://www.google.com/a/{$a->domainname}">{$a->googsettings}</a>)<br/><br/></li>
...
<li>Laden Sie die privaten Schlüssel und das Zertifikat auch in Moodle hoch und klicken Sie dann auf <b>Änderungen speichern</b></b><br/></li></ol>';
...
<ol>
    <li>Melden Sie sich bei Moodle als ein Administrator an</li>
    <li>Klicken Sie auf <b>Benachrichtigungen,</b> um die Blocktabellen zu aktualisieren</li>
    <li>Aktivieren Sie das <b>Google-Authentifizierungs-</b>Plugin auf der Admin-Seite für die Plugin-Verwaltung</li>
    <li>Wählen Sie nun die Nutzer-Authentifizierung. Gehen Sie dazu zu <b>Google-Authentifizierung.</b> Dort finden Sie Anleitungen auf der Seiten.</li>
    ...
    <li>Achten Sie darauf, das Bereitstellungs-API auf der Google-Website zu aktivieren, da sonst keine Nutzer aktualisiert werden.</li>
    <li>Stellen Sie sicher, dass die API-Bereitstellung auf der Google-Website aktiviert ist</li>
    <li>Möglicherweise müssen Sie auf der Google-Seite weitere Nutzerkonten anfordern</li>
    <li>Kehren Sie zur Hauptseite von Moodle zurück</li>
    <li>Klicken Sie auf Bearbeiten</li>
    <li>Fügen Sie der Seite GAccess-, GMail- und Gdata-Blöcke hin.</li>
    ...
    <li>Im Block GData müssen zu synchronisierende Nutzer hinzufügen. Klicken Sie dazu auf den Link zum Hinzufügen von zu synchronisierenden Nutzern im <b>Google Apps-Block</b>. Das hilft bei der Anzeige der Ergebnisse, wenn Sie den Gdata-Block-Cron auf 1 Min. festlegen.</li>
    <li>Um diesen Moodle-Nutzer in Google hochzuladen, können Sie den Cron manuell ausführen. Dazu öffnen Sie admin/cron.php. Die Ergebnisse für die Synchronisierung sollten im Lesebereich angezeigt werden.
    <b>Vorsicht: Ab dieser Beta-Version kann die Synchronisierung von Moodle-Nutzern mit Google <em>LANGE</em> Zeit dauern.</b></li>
</ol>
...
erfolgt eine Authentifizierung gegenüber Moodle.</li>
    <li>Die Nutzer müssen bei Moodle sowie bei Google-Partnerservices angemeldet sein</li>
...
In Zukunft wird das kein Problem mehr sein. Im Moment müssen Sie die Nutzer mit dem Google Apps-Block synchronisieren. E-Mail wird
...
Ab diesem Zeitpunkt muss ein Nutzer-Authentifizierungstyp überschrieben werden, wenn ein Moodle-Nutzer Kennwörter ändert.
Dieses Verhalten kann sich auf MNet-Nutzer auswirken. Eine Lösung für dieses
Problem wurde noch nicht gefunden.</li>
...
Nur Administratoren sind berechtigt, die Diagnoseinformationen anzuzeigen.</p>
...
<div class="indent">
Zur Zeit aktualisiert der Gmail-Block die ungelesenen Nachrichten eines Nutzers nur bei der Anmeldung. Sie können
...
Der Administrator muss ein <b>Verifizierungszertifikat</b> generieren und ein X.509-formatiertes Zertifikat mit einem eingebetteten öffentlichen Schlüssel zu Google hochladen.
...
<p>Diese Hilfedatei enthält eine kurze Übersicht über das Google-Gadget für Ihre Moodle-Site</p>
...
<li>Klicken Sie auf <b>Material hinzufügen</b> link</li>
...
Derzeit gibt es einen bekannten Bug, dass das Gadget nicht sofort bei der Installation aktualisiert wird.
Die Entwickler sehen sich das an.
</div>';
